			...
			<div class="FrontPage_HomeWrapper">
               ...
               <div class="frontPageCard_Container">
                  ...
                  <div class="FrontCard_Container">
                     ...
                     <c:forEach var="item" items="${noteWorthy }" begin="1">
                        <div class="card-wrapper0">
                           ...
                           <input type="hidden" id="project-no${count}" value="${item.projectNo}">
                              <button class="LikeBtn1">
                                 <svg class="like count${count} ${not empty userLikeMap[no] ? 'active' : ''}" xmlns="http://www.w3.org/2000/svg"
               ...
               <c:forEach var="item" items="${recommended }">
                  <div class="card-wrapper">
                     ...
                     <span class="projectCardDetail">
                        <dd>
                            <input type="hidden" id="project-no${count}" value="${item.projectNo}">
                           <a href="#">${item.projectKind }</a><span><a href="#">${item.projectManagerName }</a>
                              <c:set var="no" value="${item.projectNo }" />
                              <div class="LikeButton_Wrapper">
                              <button class="LikeBtn2">
                                 <svg class="like count${count} ${not empty userLikeMap[no] ? 'active' : ''}" xmlns="http://www.w3.org/2000/svg"
