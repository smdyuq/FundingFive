					...
					<div class="project_content_div">
						...
						<div>
							<label for="exampleFormControlInput1" class="form-label">프로젝트
								...
								id="exampleFormControlInput1" name="project-manager-name"  placeholder="창작자 이름을 작성해주세요."
								required>
						</div>
						...
						<div>
							<label for="exampleFormControlInput1" class="form-label">프로젝트
								...
								id="exampleFormControlInput1" name="project-manager-introduce" placeholder="창작자 소개를 작성해주세요."
								required>
						</div>
						...
						<div>
							<label for="exampleFormControlInput1" class="form-label">프로젝트
								...
								id="exampleFormControlInput1" name="project-manager-account" placeholder="창작자 계좌 작성해주세요."
								required>
						</div>
