		...
		<form id="project-administratorok-form">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control"
					...
					value="${ projectDTO.projectIntroduce}" disabled> <label
					for="exampleFormControlInput1" class="form-label">프로젝트 내용 </label>
				<div name="project-content">${projectDTO.projectContent }</div>
				...
				<input type="text" class="form-control"
					...
					value="${ projectDTO.projectTargetAmount}" disabled> <label
