	...
	<main>
            ...
            <div class="project-div">
                ...
                <div class="project-name">
                    프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름프로젝트 이름
                </div>
                        ...
                        <div class="project-text-alignment">
                            <div>
                                ...
                                <div>
                                    ...
                                    <a class="project-value">${projectDTO.getProjectRegisterDate} ~
            ...
            <div class="product-div">
                ...
                <div class="originator-div">
                    <p>창작자 소개</p>
                    <div>
                        <a class="project-manager">${projectDTO.projectManagerName}</a>
                    </div>
                    <div>
                        <a class="project-manager">${projectDTO.projectManagerIntroduce}</a>
                    </div>
