	...
	<main>
		...
		<form id="detail-form">
			...
			<div class="board_main_information">
				<div class="board_div">
					<label for="title">TITLE |</label> <input type="text" id="title"
						name="title" value="${board.title }" required disabled>
				</div>
				<div class="board_div">
					<label for="content">DATE |</label> <input type="text" id="in-date"
						name="in-date" value="${board.inDate }" required disabled>
				</div>
			</div>
			...
			<div class="board_sub_information">
				<div class="board_div">
					<label for="content">작성자 |</label> <input type="text" id="writer"
						name="writer" value="관리자" required disabled>
				</div>
				<div class="board_div">
					<label for="content">조회수 |</label> <input type="text" id="views"
						name="views" value="${board.views }" required disabled>
				</div>
			</div>
			...
			<div class="board_btn_div">
				...
				<button type="reset"
					onclick="window.location.href = '/boardList.do?cpage=1'">취소</button>
