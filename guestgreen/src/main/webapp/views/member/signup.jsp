		...
		<form action="/signup.do" method="POST">
			...
			<div class="signup-input">
				<label for="member-id">아이디:</label> <input type="text"
					id="member-id" name="member-id" onkeyup="duplicateId()" placeholder="사용하실 id를 입력해주세요." required><br>
				<span id="idMsg"></span>
			</div>
			<br>
			<div class="signup-input">
				<label for="member-pwd">비밀번호:</label> <input type="password"
					id="member-pwd" name="member-pwd" onkeyup="validatePassword()" placeholder="비밀번호를 입력해주세요."
					required> <br> <span id="passwordMsg"></span>
			</div>
			<br>
			<div class="signup-input">
				<label for="member-pwdCheck">비밀번호 확인:</label> <input type="password"
					id="member-pwdCheck" name="member-pwdCheck"
					onkeyup="validatePassword()" placeholder="비밀번호를 확인합니다." required> <br> <span
					id="passwordChkMsg"></span>
			</div>
			<br>
			<div class="signup-input">
				<label for="member-name">이름:</label> <input type="text"
					id="member-name" name="member-name" onkeyup="validateName() " placeholder="이름을 입력해주세요."
					required><br> <span id="nameMsg"></span>
			</div>
			<br>
			<div class="signup-input">
				<label for="member-phone">휴대폰 번호:</label> <input type="number" 
					id="member-phone" name="member-phone" onkeyup=""  placeholder="숫자만 입력해주세요." required><br>
				<span id="phonekMsg"></span>
			</div>
			<br>
			<div class="signup-input">
				<label for="member-addr">주소:</label> <input type="text"
					id="member-addr" name="member-addr" onkeyup="" placeholder="주소를 입력해주세요." required><br>
